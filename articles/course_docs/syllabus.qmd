...
1. Each student has **2 "flex" days** that they can use at their discretion throughout the semester. You can use both days at once for a single assignment and turn in one assignment 2 days late (with no questions asked), OR you can spread the love across different assignments. 
